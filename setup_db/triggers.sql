...
BEGIN
    ...
    -- Обновляем количество вооружения в дивизии
    UPDATE Division SET TotalWeaponry = TotalWeaponry + quantity_difference WHERE ID = divisionID;
    -- Обновляем количество вооружения в армии
    UPDATE Army SET TotalWeaponry = TotalWeaponry + quantity_difference WHERE ID = armyID;
END;
